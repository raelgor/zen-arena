...
/**
 * Creates a portable transporter object with useful methods for data
 * exchanges.
...
var DataTransporter = function () {
    ...
    (0, _createClass3.default)(DataTransporter, [{
        ...
        value: function connectMongos(url) {
            ...
            return new Promise(function (r) {
                return new mongodb.MongoClient().connect(url, function (err, db) {
                    _this.dbc = dbc = db;
                    r();
                });
            });
...
exports.default = DataTransporter;
;