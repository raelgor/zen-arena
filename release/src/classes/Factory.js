...
module.exports = function () {
   ...
   (0, _createClass3.default)(Factory, [{
      ...
      value: function setGenerator(generator) {
         if (generator) this.generator = co.wrap(generator);
      }
   }, {
      key: 'make',
      value: function make() {
         ...
         if (DEBUG_MODE) {
            var _ret = function () {
               ...
               var i = indent(_arguments[0], 1, dn);
               var t = new Timer();
               log.debug('' + i + dn + ' Starting...');
               var promise = _this.generator.apply(_this, _arguments).catch(function (e) {
                  return instance.emit('error', e);
               });
               promise.then(function () {
                  indent(_arguments[0], -1);
                  var d = t.click();
         ...
         } else return this.generator.apply(this, arguments).catch(function (e) {
            return instance.emit('error', e);
         });
      }
   }]);
